...
#ifndef __ICtxMenu_FWD_DEFINED__
#define __ICtxMenu_FWD_DEFINED__
typedef interface ICtxMenu ICtxMenu;
#endif 	/* __ICtxMenu_FWD_DEFINED__ */
...
#ifndef __ICtxMenu_INTERFACE_DEFINED__
#define __ICtxMenu_INTERFACE_DEFINED__

/* interface ICtxMenu */
/* [unique][helpstring][uuid][object] */ 


EXTERN_C const IID IID_ICtxMenu;

#if defined(__cplusplus) && !defined(CINTERFACE)
    
    MIDL_INTERFACE("16A5F684-A71B-49EB-864A-F458F0B98D8D")
    ICtxMenu : public IUnknown
    {
    public:
    };
    ...
    interface ICtxMenu
    {
        CONST_VTBL struct ICtxMenuVtbl *lpVtbl;
    };
...
#define ICtxMenu_QueryInterface(This,riid,ppvObject)	\
    ( (This)->lpVtbl -> QueryInterface(This,riid,ppvObject) ) 

#define ICtxMenu_AddRef(This)	\
    ( (This)->lpVtbl -> AddRef(This) ) 

#define ICtxMenu_Release(This)	\
    ( (This)->lpVtbl -> Release(This) ) 
...
#endif 	/* __ICtxMenu_INTERFACE_DEFINED__ */
...
class DECLSPEC_UUID("E8801615-19E6-48FB-9BFE-149FD5E97B7F")
CompReg;
#endif
