    ...
    public class ScannerTests
    {
        ...
        public void CanParseId()
        {
            var tokens = new List<Tuple<int, string, string, string>>()
            {
                ...
                new Tuple<int, string, string, string>(8 , " ", "_$123com",   "_$123com "), 
                new Tuple<int, string, string, string>(8 , ">", "_$123com",   "_$123com>"),
                new Tuple<int, string, string, string>(7 , " ", "com.mon",    "com.mon"),  
                new Tuple<int, string, string, string>(7 , " ", "com.mon",    "com.mon "),  
                new Tuple<int, string, string, string>(7 , ">", "com.mon",    "com.mon>"),
                new Tuple<int, string, string, string>(8 , " ", "_com.mon",   "_com.mon"), 
                new Tuple<int, string, string, string>(8 , " ", "_com.mon",   "_com.mon "), 
                new Tuple<int, string, string, string>(8 , ">", "_com.mon",   "_com.mon>" ),
                new Tuple<int, string, string, string>(8 , " ", "$com.mon",   "$com.mon"), 
                new Tuple<int, string, string, string>(8 , " ", "$com.mon",   "$com.mon "), 
                new Tuple<int, string, string, string>(8 , ">", "$com.mon",   "$com.mon>" ),
                new Tuple<int, string, string, string>(8 , "(", "$com.mon",   "$com.mon(>" )
            };
