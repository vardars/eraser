...
namespace alglib
{
    public class testinvunit
    {
        ...
        *************************************************************************/
        public static bool testinv(bool silent)
        {
            ...
            for(n=1; n<=maxn; n++)
            {
                ...
                for(gpass=1; gpass<=gpasscount; gpass++)
                {
                    ...
                    for(i=0; i<=n-1; i++)
                    {
                        a[i,(i+k)%n] = 2*AP.Math.RandomReal()-1;
                    }
                    testproblem(ref a, n);
            ...
            if( !silent )
            {
                System.Console.Write("TESTING INVERSE");
        ...
        *************************************************************************/
            ...
            int n)
        {
            ...
            inv.rmatrixinverse(ref b, n);
            makeacopy(ref a, n, n, ref blu);
            trfac.rmatrixlu(ref blu, n, n, ref p);
            inv.rmatrixluinverse(ref blu, ref p, n);
        ...
        *************************************************************************/
        ...
        Silent unit test
        *************************************************************************/
        public static bool testinvunit_test_silent()
        {
            bool result = new bool();
        ...
        Unit test
        *************************************************************************/
        public static bool testinvunit_test()
        {
            bool result = new bool();
