...
namespace alglib
{
    public class testsevdbiunit
    {
        /*************************************************************************
        Testing symmetric EVD, BI
        *************************************************************************/
        public static bool testsevdbi(bool silent)
        {
            ...
            if( !silent )
            {
                System.Console.Write("TESTING SYMMETRIC BISECTION AND INVERSE ITERATION EVD");
        ...
        *************************************************************************/
        ...
        Reference EVD
        *************************************************************************/
        private static bool refevd(double[,] a,
            int n,
            ref double[] lambda,
            ref double[,] z)
        {
            ...
            // to tridiagonal
            //
            tridiagonal.smatrixtd(ref a, n, true, ref tau, ref d, ref e);
            tridiagonal.smatrixtdunpackq(ref a, n, true, ref tau, ref z2);
            ...
            result = sbitridiagonalqlieigenvaluesandvectors(ref d1, e1, n, ref z1);
            if( result )
            {
        ...
        private static bool sbitridiagonalqlieigenvaluesandvectors(ref double[] d,
            double[] e,
            int n,
            ref double[,] z)
        {
        ...
        *************************************************************************/
        ...
        Tests EVD problem
        *************************************************************************/
        private static void testevdproblem(ref double[,] afull,
            ref double[,] al,
            ref double[,] au,
            int n,
            ref double valerr,
            ...
            ref int failc)
        {
            ...
            for(i1=0; i1<=n-1; i1++)
            {
                for(i2=i1; i2<=n-1; i2++)
                {
                    ...
                    unset1d(ref lambda);
                    unset2d(ref z);
                    if( !sbisinv.smatrixevdr(al, n, 0, false, a, b, ref m, ref lambda, ref z) )
                    {
                        failc = failc+1;
                        return;
                    }
                    ...
                    unset1d(ref lambda);
                    unset2d(ref z);
                    if( !sbisinv.smatrixevdr(au, n, 0, true, a, b, ref m, ref lambda, ref z) )
                    {
                        failc = failc+1;
                        return;
                    }
                    ...
                    unset1d(ref lambda);
                    unset2d(ref z);
                    if( !sbisinv.smatrixevdi(al, n, 0, false, i1, i2, ref lambda, ref z) )
                    {
                        failc = failc+1;
                        return;
                    }
                    ...
                    unset1d(ref lambda);
                    unset2d(ref z);
                    if( !sbisinv.smatrixevdi(au, n, 0, true, i1, i2, ref lambda, ref z) )
                    {
                        failc = failc+1;
                        return;
                    }
                    ...
                    unset1d(ref lambda);
                    unset2d(ref z);
                    if( !sbisinv.smatrixevdr(al, n, 1, false, a, b, ref m, ref lambda, ref z) )
                    {
                        failc = failc+1;
                        return;
                    }
                    ...
                    unset1d(ref lambda);
                    unset2d(ref z);
                    if( !sbisinv.smatrixevdr(au, n, 1, true, a, b, ref m, ref lambda, ref z) )
                    {
                        failc = failc+1;
                        return;
                    }
                    ...
                    unset1d(ref lambda);
                    unset2d(ref z);
                    if( !sbisinv.smatrixevdi(al, n, 1, false, i1, i2, ref lambda, ref z) )
                    {
                        failc = failc+1;
                        return;
                    }
                    ...
                    unset1d(ref lambda);
                    unset2d(ref z);
                    if( !sbisinv.smatrixevdi(au, n, 1, true, i1, i2, ref lambda, ref z) )
                    {
                        failc = failc+1;
                        return;
                    }
        ...
        Silent unit test
        *************************************************************************/
        public static bool testsevdbiunit_test_silent()
        {
            bool result = new bool();
        ...
        Unit test
        *************************************************************************/
        public static bool testsevdbiunit_test()
        {
            bool result = new bool();
