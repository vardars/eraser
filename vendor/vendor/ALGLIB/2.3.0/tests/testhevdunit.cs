...
namespace alglib
{
    public class testhevdunit
    {
        /*************************************************************************
        Testing symmetric EVD subroutine
        *************************************************************************/
        public static bool testhevd(bool silent)
        {
            ...
            if( !silent )
            {
                System.Console.Write("TESTING HERMITIAN EVD");
        ...
        *************************************************************************/
        private static double testproduct(ref AP.Complex[,] a,
            int n,
            ref AP.Complex[,] z,
            ref double[] lambda)
        {
        ...
        *************************************************************************/
        private static double testort(ref AP.Complex[,] z,
            int n)
        {
            double result = 0;
            int i = 0;
        ...
        Tests EVD problem
        *************************************************************************/
        private static void testevdproblem(ref AP.Complex[,] a,
            ref AP.Complex[,] al,
            ref AP.Complex[,] au,
            int n,
            ref double materr,
            ...
            ref int failc)
        {
            ...
            unset2d(ref z);
            wsucc = hevd.hmatrixevd(al, n, 1, false, ref lambdaref, ref z);
            if( !wsucc )
            {
                failc = failc+1;
                return;
            ...
            unset1d(ref lambda);
            unset2d(ref z);
            wsucc = hevd.hmatrixevd(au, n, 1, true, ref lambda, ref z);
            if( !wsucc )
            {
                failc = failc+1;
                return;
            ...
            unset1d(ref lambda);
            unset2d(ref z);
            wsucc = hevd.hmatrixevd(al, n, 0, false, ref lambda, ref z);
            if( !wsucc )
            {
                failc = failc+1;
                return;
            ...
            unset1d(ref lambda);
            unset2d(ref z);
            wsucc = hevd.hmatrixevd(au, n, 0, true, ref lambda, ref z);
            if( !wsucc )
            {
                failc = failc+1;
                return;
        ...
        Silent unit test
        *************************************************************************/
        public static bool testhevdunit_test_silent()
        {
            bool result = new bool();
        ...
        Unit test
        *************************************************************************/
        public static bool testhevdunit_test()
        {
            bool result = new bool();
