...
namespace alglib
{
    public class testlqunit
    {
        ...
        *************************************************************************/
        public static bool testlq(bool silent)
        {
            ...
            if( !silent )
            {
                System.Console.Write("TESTING RMatrixLQ");
        ...
        *************************************************************************/
            ...
            int n)
        {
            ...
            lq.rmatrixlq(ref b, m, n, ref taub);
            lq.rmatrixlqunpackq(ref b, m, n, ref taub, n, ref q);
            lq.rmatrixlqunpackl(ref b, m, n, ref l);
            for(i=0; i<=m-1; i++)
            {
                for(j=0; j<=n-1; j++)
                {
            ...
            for(i=0; i<=m-1; i++)
            {
                ...
                {
                    structerrors = structerrors | (double)(l[i,j])!=(double)(0);
                }
            }
            for(i=0; i<=n-1; i++)
            {
            ...
            for(k=1; k<=n-1; k++)
            {
                lq.rmatrixlqunpackq(ref b, m, n, ref taub, k, ref q2);
                for(i=0; i<=k-1; i++)
                {
                    for(j=0; j<=n-1; j++)
                    {
                        othererrors = othererrors | (double)(q2[i,j])!=(double)(q[i,j]);
                    }
                }
            }
        }
        ...
        Silent unit test
        *************************************************************************/
        public static bool testlqunit_test_silent()
        {
            bool result = new bool();
        ...
        Unit test
        *************************************************************************/
        public static bool testlqunit_test()
        {
            bool result = new bool();
